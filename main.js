...
(function () {
    ...
    const translations = {
        en: {
            // Navigation & Titles
            essence: "Expertise",
            collection: "Our Selection",
            testimonials: "Client Reviews",
            connect: "Inquire",
            heroTitle: "MARBLE AQWAS",
            heroTagline: "Sourcing Excellence in Natural Stone for Lasting Spaces",

            // About / Essence Section
            essenceTitle: "Precision & Craftsmanship",
            essenceText: "At Marble Aqwas, we don't just supply stone; we help you choose the right foundation for your home. Our focus is on technical durability, honest advice, and precise finishing—ensuring that every slab we install stands the test of time and use.",

            // Collection Section
            collectionTitle: "Premium Natural Selection",
            collectionSubtitle: "Materials chosen for their strength, character, and aesthetic value.",
            item1: "Natural Granite",
            item1Desc: "The most practical choice for high-traffic surfaces. Known for its extreme resistance to heat and scratches, it is the ideal long-term investment for kitchen countertops and outdoor flooring.",
            item2: "Natural Marble",
            item2Desc: "A timeless classic that synthetic materials cannot replicate. With its unique natural veining and cooling properties, it remains the ultimate choice for luxury flooring and elegant interiors.",
            item3: "Engineered Stone",
            item3Desc: "A modern, high-performance solution. Its non-porous surface makes it exceptionally hygienic and easy to maintain, perfect for contemporary designs that require consistency and cleanliness.",

            // Testimonials (Real Human Feedback)
            testimonialsTitle: "What Our Clients Say",
            testimonial1: "\"The finishing on the marble was exceptional. They respected the delivery timeline and the installation team was very precise with the measurements.\"",
            testimonial1Author: "— Dr. Ahmed Al-Mansouri",
            testimonial2: "\"We've had their granite in our kitchen for years; it still looks brand new. It's rare to find this kind of quality and honest guidance in the market.\"",
            testimonial2Author: "— Sarah Benjelloun",
            testimonial3: "\"Professional service from start to finish. They helped us understand the difference between materials so we could make the right choice for our budget.\"",
            testimonial3Author: "— Omar Idrissi",

            // Contact Section
            connectTitle: "Start Your Project",
            namePlaceholder: "Full Name",
            emailPlaceholder: "Email Address",
            messagePlaceholder: "Tell us about your project requirements...",
            inquire: "Request a Consultation",
            mobileContactBtn: "Contact via WhatsApp",

            // Footer
            footerAbout: "The Company",
            footerOurStory: "Our Heritage",
            footerTeam: "Technical Team",
            footerCareers: "Opportunities",
            footerServices: "Professional Services",
            footerInstallation: "Stone Installation",
            footerConsultation: "Technical Consulting",
            footerMaintenance: "Polishing & Care",
            footerContact: "Get in Touch",
            footerAddress: "Asilah, Morocco",
            footerFollow: "Our Portfolio",
        ...
        ar: {
            ...
            essence: "خبرتنا",
            collection: "مجموعتنا",
            testimonials: "شهادات الزبناء",
            connect: "تواصل معنا",
            heroTitle: "رخام أقواس",
            heroTagline: "نختار أجود أنواع الحجر الطبيعي لمساحات تدوم طويلاً",

            // قسم الجوهر / من نحن
            essenceTitle: "الدقة والإتقان",
            essenceText: "في رخام أقواس، نحن لا نكتفي بتوريد الحجر، بل نوجهك لاختيار الأساس الأنسب لمنزلك. نرتكز في عملنا على المتانة التقنية، النصيحة الصادقة، والدقة في التشطيب (الفينيسيون) لنضمن لك نتيجة تفوق توقعاتك.",

            // قسم المجموعة
            collectionTitle: "تشكيلة مختارة بعناية",
            collectionSubtitle: "خامات متميزة تم اختيارها لقوتها، جمالها الطبيعي، وقيمتها المعمارية.",
            item1: "الجرانيت الطبيعي",
            item1Desc: "الخيار العملي الأول للأسطح الأكثر استخداماً. بفضل مقاومته الفائقة للحرارة والخدوش، يعد الاستثمار الأمثل لمطابخكم والأرضيات الخارجية التي تتطلب متانة عالية.",
            item2: "الرخام الطبيعي",
            item2Desc: "كلاسيكية فاخرة لا يمكن للمواد الصناعية محاكاتها. بعروقه الفريدة وبرودته الطبيعية، يظل الخيار الأرقى للأرضيات والمجالس التي تبحث عن الفخامة والتميز.",
            item3: "الحجر المصنع",
            item3Desc: "حل عصري يجمع بين الجمال والوظيفة. سطحه غير المسامي يضمن أعلى مستويات النظافة وسهولة العناية، مما يجعله مثالياً للتصاميم الحديثة والعملية.",

            // آراء العملاء (كلام واقعي)
            testimonialsTitle: "شهادات من واقع عملنا",
            testimonial1: "«إتقان كبير في تشطيب الرخام، التزام تام بمواعيد التسليم، وفريق التركيب كان دقيقاً جداً في القياسات والتعامل.»",
            testimonial1Author: "— د. أحمد المنصوري",
            testimonial2: "«ركبنا الجرانيت في مطبخنا منذ سنوات ولا يزال كأنه جديد. من الصعب أن تجد هذا الجمع بين الجودة والنصيحة الصادقة في السوق حالياً.»",
            testimonial2Author: "— سارة بن جلون",
            testimonial3: "«خدمة احترافية من البداية للنهاية. ساعدونا في فهم الفرق بين الخامات لنختار الأنسب لميزانيتنا واحتياجاتنا.»",
            testimonial3Author: "— عمر الإدريسي",

            // قسم التواصل
            connectTitle: "ابدأ مشروعك معنا",
            namePlaceholder: "الاسم الكامل",
            emailPlaceholder: "البريد الإلكتروني",
            messagePlaceholder: "أخبرنا عن تفاصيل طلبك أو استفسارك...",
            inquire: "طلب استشارة فنية",
            mobileContactBtn: "تواصل عبر واتساب",

            // التذييل
            footerAbout: "عن المؤسسة",
            footerOurStory: "مسارنا",
            footerTeam: "الفريق التقني",
            footerCareers: "فرص العمل",
            footerServices: "خدماتنا المهنية",
            footerInstallation: "توريد وتركيب الرخام",
            footerConsultation: "معاينة واستشارات فنية",
            footerMaintenance: "جلي وتلميع الأحجار",
            footerContact: "معلومات التواصل",
            footerAddress: "أصيلة، المغرب",
            footerFollow: "أعمالنا السابقة",
            footerInstagram: "إنستغرام",
            footerFacebook: "فيسبوك",
            footerLinkedin: "لينكد إن",
            footerCopyright: "© 2025 رخام أقواس. جميع الحقوق محفوظة.",
